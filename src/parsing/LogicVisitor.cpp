...
/*std::variant<CanonicalSet, CanonicalRelation>*/ std::any Logic::visitTransitiveClosure(
  ...
  if (std::holds_alternative<CanonicalRelation>(relationExpression)) {
    ...
    const CanonicalRelation rrStar = Relation::newRelation(RelationOperation::composition, r, rStar);
...
/*std::variant<CanonicalSet, CanonicalRelation>*/ std::any Logic::visitRelationFencerel(
  ...
  if (definedRelations.contains(relationName)) {
    ...
    const CanonicalRelation po_r_po = Relation::newRelation(RelationOperation::composition, po_r, po);
...
/*std::variant<CanonicalSet, CanonicalRelation>*/ std::any Logic::visitUnion(
  ...
  const auto e1 = std::any_cast<std::variant<CanonicalSet, CanonicalRelation>>(context->e1->accept(this));
  const auto e2 = std::any_cast<std::variant<CanonicalSet, CanonicalRelation>>(context->e2->accept(this));
...
/*std::variant<CanonicalSet, CanonicalRelation>*/ std::any Logic::visitRelationIdentity(
  ...
  if (context->TOID() == nullptr) {
    ...
    const CanonicalRelation r_and_id = Relation::newRelation(RelationOperation::intersection, r, id);
...
/*std::variant<CanonicalSet, CanonicalRelation>*/ std::any Logic::visitTransitiveReflexiveClosure(
  ...
  const auto e = std::any_cast<std::variant<CanonicalSet, CanonicalRelation>>(context->e->accept(this));
