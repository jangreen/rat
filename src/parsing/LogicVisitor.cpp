...
namespace {
antlr4::ParseCancellationException parsingError(antlr4::ParserRuleContext *context,
                                                std::string message) {
...
/*Cube*/ std::any Logic::visitAssertion(LogicParser::AssertionContext *context) {
  ...
  if (!sameType) {
    throw parsingError(context, "Type mismatch in assertion.");
  }
  ...
  if (isSetAssertion) {
    ...
    return Cube{Literal::newSetNonEmptiness(false, lhSet),
                Literal::newSetNonEmptiness(true, rhSet)};
  }
  ...
  return Cube{Literal::newSetNonEmptiness(false, e1LHS_and_e2),
              Literal::newSetNonEmptiness(true, e1RHS_and_e2)};
}
...
/*std::vector<Constraint>*/ std::any Logic::visitMcm(LogicParser::McmContext *context) {
  ...
  for (const auto definitionContext : context->definition()) {
    if (definitionContext->letDefinition()) {
      ...
      throw parsingError(context, "Recursive definitions are not supported.");
...
/*void*/ std::any Logic::visitLetDefinition(LogicParser::LetDefinitionContext *context) {
  ...
  if (context->RELNAME()) {
    ...
    if (!std::holds_alternative<CanonicalRelation>(expr)) {
      throw parsingError(context, "Set identifier must start with a uppercase letter.");
    }
    ...
    if (!std::holds_alternative<CanonicalSet>(expr)) {
      throw parsingError(context, "Relation identifier must start with a lowercase letter.");
    }
...
/*void*/ std::any Logic::visitLetRecDefinition(LogicParser::LetRecDefinitionContext *context) {
  throw parsingError(context, "Recursive definitions are currently not supported.");
}
...
/*CanonicalExpression*/ std::any Logic::visitTransitiveClosure(
  ...
  throw parsingError(context, "Type mismatch of the operand of the relation transitive closure.");
}
...
/*CanonicalExpression*/ std::any Logic::visitUnion(LogicParser::UnionContext *context) {
  ...
  throw parsingError(context, "Type mismatch of two operands of the union operator.");
}
...
/*CanonicalExpression*/ std::any Logic::visitRelationIdentity(
  ...
  throw parsingError(context, "'visitExprIdentity TOID' expressions are not supported.");
}
...
/*CanonicalExpression*/ std::any Logic::visitTransitiveReflexiveClosure(
  ...
  throw parsingError(context, "Type mismatch of operand of the Kleene operator.");
}
/*CanonicalExpression*/ std::any Logic::visitComposition(LogicParser::CompositionContext *context) {
  ...
  throw parsingError(context, "Type mismatch of two operands of the composition operator.");
}
